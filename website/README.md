...
- Footer version should match [pyproject.toml](../pyproject.toml) `version` (currently **0.9.5**).
- Install snippet matches README: Docker Compose as default; host Python / venv linked as advanced.
